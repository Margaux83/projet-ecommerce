...
<div class="shop_top">
  <div class="container">
    <form action="/snowboarding/src/view/Shop/shop-hommes.php" method="post">
      ...
      <button type="submit" name="t-shirt" class="btn_form" href="/snowboarding/src/view/Shop/shop-hommes.php">T-shirts</button>
      <button type="submit" name="pantalon" class="btn_form" href="/snowboarding/src/view/Shop/shop-hommes.php">Pantalons</button>
      <button type="submit" name="chaussures" class="btn_form" href="/snowboarding/src/view/Shop/shop-hommes.php">Chaussures</button>
      <button type="submit" name="accessoires" class="btn_form" href="/snowboarding/src/view/Shop/shop-hommes.php">Accessoires</button>
      <button type="submit" name="soldes" class="btn_form" href="/snowboarding/src/view/Shop/shop-hommes.php">Soldes</button>
      </form>
    <?php if(isset($_POST['homme'])){ ?>
  <form action="/snowboarding/src/view/Shop/shop-hommes.php" method="post">
...
<!------------SECTION "TOUS LES ARTICLES"--------->
      ...
      $result=$items->afficheAllItemsHomme();
...
if(isset($_POST['t-shirt'])){
  ...
  include "../../model/itemsManager.php";
$items = new itemsManager();
$m=$items->afficheTshirtHommeItems();?>
<div class="row ">
...
include "../../model/itemsManager.php";
$items = new itemsManager();
$m=$items->affichePantalonHommeItems();?>
<div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheChaussuresHommeItems();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheSoldeHommeItems();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheAllItemsHommeAsc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheAllItemsHommeDesc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheTshirtHommeItemsAsc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheTshirtHommeItemsDesc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->affichePantalonHommeItemsAsc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->affichePantalonHommeItemsDesc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheChaussuresHommeItemsAsc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheChaussuresHommeItemsDesc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheSoldeHommeItemsAsc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
...
<div class="container">
     ...
     include "../../model/itemsManager.php";
$items = new itemsManager();
 $m=$items->afficheSoldeItemsHommeDesc();?>
 <div class="row ">
<?php   foreach ($m as $donnees){ ?>
