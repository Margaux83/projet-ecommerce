                        ...
                        <div class="col-xs-12 col-sm-2 col-md-2 dashboard-nav">
                          <ul class="nav nav-tabs nav-stacked text-center">
                                <li class="active"><a href="#"><span><i class="fa fa-user"></i></span>Profil</a></li>
                                  <li><a href="message.php"><span><i class="fa fa-briefcase"></i></span>Mes messages</a></li>
                              </ul>
                          </div><!-- end columns -->
                              ...
                              <div class="panel panel-default">
                                  ...
                                  <div class="panel-body">
                                    <div class="row">
                                      ...
                                      // Inclusion de la classe "classinscri.php" et "inscriManager.php"
                                      include "../model/classinscri.php";
                                      include "../model/inscriManager.php";

                                      // Creation d'un nouvel objet "membre" de type "inscriManager"
                                      $membre = new inscriManager();
                                      // Execution de la fonction "afficheAdmin"
                                      $result = $membre->afficheAdmin();
